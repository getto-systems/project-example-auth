...
func ExamplePasswordReset_reset() {
	...
	h.newRequest("PasswordReset/CreateSession", minute(0), passwordResetHandler, func() {
		NewPasswordReset(u).CreateSession(passwordResetHandler)
	...
	h.newRequest("PasswordReset/GetStatus", minute(1), passwordResetHandler, func() {
		NewPasswordReset(u).GetStatus(passwordResetHandler)
	}, func(f testFormatter) {
		f.printRequest()
		f.printError()
	...
	h.newRequest("PasswordReset/SendToken", minute(2), passwordResetHandler, func() {
		NewPasswordReset(u).SendToken(passwordResetHandler)
	}, func(f testFormatter) {
		f.printError()
		f.printMessage()
	})
	...
	h.newRequest("PasswordReset/Reset", minute(4), passwordResetHandler, func() {
		NewPasswordReset(u).Reset(passwordResetHandler)
	}, func(f testFormatter) {
		f.printRequest()
...
func ExamplePasswordReset_getStatusFailedBecauseDifferentLogin() {
	...
	h.newRequest("PasswordReset/CreateSession", minute(0), another_passwordResetHandler, func() {
		NewPasswordReset(u).CreateSession(another_passwordResetHandler)
	}, func(f testFormatter) {
		f.printError()
	})
