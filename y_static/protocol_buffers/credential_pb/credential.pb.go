...
type ApiCredentialMessage struct {
...
func (x *ApiCredentialMessage) Reset() {
	*x = ApiCredentialMessage{}
...
func (x *ApiCredentialMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApiCredentialMessage) ProtoMessage() {}

func (x *ApiCredentialMessage) ProtoReflect() protoreflect.Message {
	mi := &file_credential_proto_msgTypes[0]
...
// Deprecated: Use ApiCredentialMessage.ProtoReflect.Descriptor instead.
func (*ApiCredentialMessage) Descriptor() ([]byte, []int) {
	return file_credential_proto_rawDescGZIP(), []int{0}
}

func (x *ApiCredentialMessage) GetNonce() string {
	if x != nil {
		return x.Nonce
	}
	return ""
...
func (x *ApiCredentialMessage) GetRoles() []string {
	if x != nil {
		return x.Roles
	}
	return nil
...
var file_credential_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x42,
	0x0a, 0x14, 0x41, 0x70, 0x69, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05,
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x72, 0x6f, 0x6c,
	0x65, 0x73, 0x42, 0x20, 0x5a, 0x1e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5f, 0x62,
	0x75, 0x66, 0x66, 0x65, 0x72, 0x73, 0x2f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61,
...
var file_credential_proto_goTypes = []interface{}{
	(*ApiCredentialMessage)(nil), // 0: credential.ApiCredentialMessage
}
...
func file_credential_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_credential_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApiCredentialMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
